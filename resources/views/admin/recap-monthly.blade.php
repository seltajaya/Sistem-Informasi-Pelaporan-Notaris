    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="GET" class="mb-6 bg-white p-4 rounded-lg shadow-sm flex items-end gap-4">
                ...
                <a href="{{ route('admin.recap.annual', ['region_id' => request('region_id')]) }}" class="text-sm text-gray-600 hover:text-gray-900 self-center">← Kembali ke Tahunan</a>
            </form>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-4 py-3 text-left font-medium text-gray-500 uppercase tracking-wider">Bulan</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($months as $row)
                                    <tr>
                                        <td class="px-4 py-3 font-semibold">{{ $monthsNames[$row->report_month] }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="px-4 py-6 text-center text-gray-500">Belum ada data untuk tahun {{ $year }}.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
